# Getting Started
 ...
 [![](https://github.com/typeorm/typeorm/raw/master/resources/logo_big.png)](http://typeorm.io/)  
  
 [![](https://circleci.com/gh/typeorm/typeorm/tree/master.svg?style=shield)](https://app.circleci.com/pipelines/github/typeorm/typeorm) [![](https://badge.fury.io/js/typeorm.svg)](https://badge.fury.io/js/typeorm) [![](https://david-dm.org/typeorm/typeorm.svg)](https://david-dm.org/typeorm/typeorm) [![Codecov](https://img.shields.io/codecov/c/github/typeorm/typeorm.svg)](https://codecov.io/gh/typeorm/typeorm) [![](https://img.shields.io/badge/chat-on%20slack-blue.svg)](https://join.slack.com/t/typeorm/shared_invite/zt-gej3gc00-hR~L~DqGUJ7qOpGy4SSq3g)  
...
4. Install a database driver:
   ...
   * for **SAP Hana**
     ...
     _SAP Hana support made possible by sponsorship of_ [_Neptune Software_](https://www.neptune-software.com/)_._
...
_Entity_ is your model decorated by an `@Entity` decorator. A database table will be created for such models. You work with entities everywhere with TypeORM. You can load/insert/update/remove and perform other operations with them.
...
Column types are database-specific. You can set any column type your database supports. More information on supported column types can be found [here](docs/entities.md#column-types).
...
Here, photos will contain an array of photos from the database, and each photo will contain its photo metadata. Learn more about Find Options in [this documentation](docs/find-options.md).
...
You'll use the query builder in your application a lot. Learn more about QueryBuilder [here](docs/select-query-builder.md).
